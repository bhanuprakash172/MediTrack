  ...
  elseif(!isset($_POST["choice-submit"])){
      ...
      <div class='choice_form_box'>
        <form class='choice_form' action='dinsert.php' method='post'>
          ...
          <label for='ch'>Upload image</label>
...
elseif ($_POST["ch"]=="4") {
          echo "  <div class='welcome'><h2 class='welcome_mssg'> Upload Form</h2></div>
  <div class='input-form-box'>
    <form class='input-form' action='dinsert_img.php' method='post' enctype='multipart/form-data'>
      <label for='pssn'>Patient ID</label>
      <input type='text' name='pssn' placeholder='Enter a valid Patient ID' required><br>
      ...
      <label for='description'>Description</label>
      <textarea name='description' placeholder='image upload Description' required ></textarea><br>

    <label for='upload image'>upload image</label>
	<input type='file' name='prescription_files[]' accept='image/' multiple>
